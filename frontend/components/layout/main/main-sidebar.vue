...
import {CalendarIcon, ChartPieIcon, Cog6ToothIcon, DocumentDuplicateIcon, FolderIcon, HomeIcon, UsersIcon, XMarkIcon } from "@heroicons/vue/24/outline";
import {useSidebarStore} from "~/stores/useSidebarStore";


//sidebar 제어
const sidebarStore = useSidebarStore();
const sidebarOpen = ref(sidebarStore.sidebarOpen);
watch(() => sidebarStore.sidebarOpen, (newValue) => {
